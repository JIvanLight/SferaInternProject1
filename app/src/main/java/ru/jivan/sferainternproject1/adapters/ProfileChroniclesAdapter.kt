...
class ProfileChroniclesAdapter() :
    ListAdapter<Int, ProfileChroniclesAdapter.ChroniclesViewHolder>(ProfileChroniclesAdapter.DiffCallback) {
    ...
    class ChroniclesViewHolder(binding: ItemRecyclerProfileChroniclesBinding) :
